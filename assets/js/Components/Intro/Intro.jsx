...
const contexts = {
  desk, plant, floatWeb, floatCode, smoke,
};
...
export default class Intro extends React.Component {
  ...
  componentDidMount() {
    const { illustrationLandscape, msgIndex } = this.state;
    ...
    this.interval = setInterval(() => {
      ...
      this.setState((v) => ({
        ...
        this.swapper.current.swap(this.#swapperData[msgIndex].message);
      });
    }, 4000);
  }
  ...
  render() {
    const { illustrationLandscape: landscape, illustrationState, msgIndex } = this.state;
      ...
      <section id="intro">
        <section className="text">
          <h1>
            ...
            There
            {' '}
            <FontAwesomeIcon icon={faHand} className="fa-wave" />
          </h1>
          <h2>
            I
            <em>&apos;</em>
          ...
          <p>
            <ComponentSwapper ref={this.swapper} {...this.#swapperData[msgIndex].effect}>
